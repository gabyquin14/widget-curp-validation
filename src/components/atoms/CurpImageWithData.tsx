...
const CurpImageWithData = ({ data }: Props) => {
  return (
    <div className="relative">
      ...
      <span className="absolute left-[30%] bottom-[8%] text-black px-2 py-1 rounded text-sm">
        {data?.document_data.anioReg}
      </span>
      <span className="absolute left-[47%] bottom-[8%] text-black px-2 py-1 rounded text-sm">
        {data?.document_data.libro}
      </span>
      <span className="absolute right-[25%] bottom-[8%] text-black px-2 py-1 rounded text-sm">
